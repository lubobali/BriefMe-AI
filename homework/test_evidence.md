...
All 47 tests pass. Run with: `python -m pytest briefme/test_briefme.py -v`
...
TestEdgeCases (9 tests) — Non-approved sender, rate limit, mixed intent, FYI regression, FYI word boundary, security policy x2, outbound recipient scoping, no secrets in logs
